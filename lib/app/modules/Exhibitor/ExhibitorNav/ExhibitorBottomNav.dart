...
class ExhibitorNavItem {
  const ExhibitorNavItem(this.icon, this.label);
...
const exhibitorNavItems = [
  ExhibitorNavItem(Icons.home_rounded, 'Home'),
        ...
        child: SizedBox(
          ...
          child: Row(
            children: List.generate(
              exhibitorNavItems.length,
                  (index) => Expanded(
                child: _NavItem(
                  item: exhibitorNavItems[index],
